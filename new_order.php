...
$filters = $pdo->query("SELECT DISTINCT TRIM(`filter`) AS f FROM panel_filter_structure WHERE TRIM(`filter`)<>'' ORDER BY f")->fetchAll();
...
<div class="wrap">
    ...
    <div style="display:flex;gap:16px;align-items:center;margin-bottom:8px;flex-wrap:wrap">
        ...
        <label>Цех (опц.): <input id="workshop" type="text" value="U2" style="width:200px"></label>
