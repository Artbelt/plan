...
<script>
    function loadDoc_1() {
        ...
        var request = "load_parts_from_db.php?part="+document.getElementById("text").value;
...
<script>
    ...
    function send_parts_to_write_off() {//отправка данных для списания выпуска продукции
        ...
        xhttp.open("POST", "write_off_parts.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send("parts_for_write_off_json="+filters_for_write_off_json
...
<div class="simple">
    ...
    <table border="0" width="400px">
        <tr>
            <td height="25" align="center" bgcolor="#1e90ff">Гофропакет<br>
            ...
            <td rowspan="2" align="center" bgcolor="#1e90ff" >
                ...
                Выпущенная продукция <p>
                    <select id="maked_filters" name="filters" size="15" ><!--Список выпущенной продукции -->
                    </select>
                    <br>
                    по заявке № <br>
                    <?php load_orders() ?>
        ...
        <tr>
            ...
            <td align="center" bgcolor="#1e90ff">
                ...
                <p id="summ"></p>
                <input type="button" onclick="send_parts_to_write_off()" value="Провести выпуск продукции"/>
            </td>
        </tr>
    </table>
    <br>
